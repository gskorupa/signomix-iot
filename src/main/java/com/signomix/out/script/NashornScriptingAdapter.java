...
public class NashornScriptingAdapter extends OutboundAdapter implements Adapter, ScriptingAdapterIface {
    ...
    private static final org.slf4j.Logger logger = LoggerFactory.getLogger(NashornScriptingAdapter.class);
    ...
    public void loadProperties(HashMap<String, String> properties, String adapterName) {
        ...
        logger.info("\tscript-file: {}", scriptLocation);
        decoderEnvelopeLocation = properties.get("decoder-envelope-location");
        logger.info("\tdecoder-envelope-location: {}", decoderEnvelopeLocation);
        helperName = properties.get("helper-name");
        logger.info("\thelper-name: {}",helperName);
    ...
    public String readScript(String path) {
        ...
        try {
         ...
         the while loop usually has a single iteration only.
            ...
            logger.info(e.getMessage() + ". Reading from the classpath.");
    ...
    private void fireEvent(int source, String origin, String message) {
        ...
        if (source == 1) {
           data.put("message","Decoder script (1): " + message);
        } else {
            data.put("message","Data processor script (1): " + message);
        }
